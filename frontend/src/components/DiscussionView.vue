            ...
            <span class="text-ink-gray-5">
              {{
                discussion.participants_count == 1
                  ? __('1 participant')
                  : __(`${discussion.participants_count} participants`)
              }}
            </span>
          </div>
        </div>
          ...
          >
            {{
              discussionMoveDialog.project
                ? __('Move to {label}', { label: discussionMoveDialog.project.label })
                : __('Move')
            }}
          </Button>
        </template>
          ...
          moveToProject: {
            ...
            validate(params) {
              if (!params.args.project) {
                return __('Project is required to move this discussion')
              }
            },
            onError() {
